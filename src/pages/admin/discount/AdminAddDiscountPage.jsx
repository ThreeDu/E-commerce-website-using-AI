  ...
  return (
    <main className="w-[min(1100px,92%)] mx-auto flex-1 py-10">
      <section className="relative border border-shop-line rounded-2xl p-6 shadow-admin bg-gradient-to-br from-white to-[#f8fbff] animate-admin-rise">
        <h2 className="text-xl font-bold text-admin-ink tracking-tight">Thêm mã giảm giá</h2>
        <p className="text-sm text-admin-muted mt-1.5 mb-0 max-w-[760px] leading-relaxed">Thiết lập chương trình khuyến mãi với thời gian áp dụng, điều kiện và giới hạn sử dụng rõ ràng.</p>
